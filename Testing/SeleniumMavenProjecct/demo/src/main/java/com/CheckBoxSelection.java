 ...
 * 
 * 2. Locate checkbox elements “Red”, “Blue”, and “Orange”, and click on them
 * for selecting.
 * 
 * Let’s write the source code for this scenario.
 * 
 */
public class CheckBoxSelection implements AutoCloseable {
    ...
    public static void assertTrue() {
        try {
            ...
            WebElement orangeCheckBoxElement = driver
                    .findElement(By.xpath("//input[@name='color' and @value='orange']"));
            orangeCheckBoxElement.click();

            // Assert.assertTrue();
            if (redCheckBoxElement.isSelected() && blueCheckBoxElement.isSelected()
                    && orangeCheckBoxElement.isSelected()) {
