...
public class DataSupplier{
    //-------------------------------Data Provider for single Diamentional array---------------
    ...
    // }
     ...
     //-------------------------------Data Provider for Two Diamentional array---------------
    // @Test(dataProvider = "dp1")
    // public void login(Object[] object){
    ...
    //---------------------------Data Provider for iterator<String>----------------------
    //  @Test(dataProvider = "dp1")
    ...
    //----------------------------Data provider for Iterator<String,String>-------------------
    ...
    //----------------------------Data Provider from DataProvider Class-----------------
